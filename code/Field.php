...
use Modular\Interfaces\Field as FieldInterface;
use Modular\Interfaces\HasMode;
use Modular\Traits\bitfield;
use Modular\Traits\lang;
use Modular\Types\Traits\value;
use SilverStripe\Forms\CheckboxField;
use SilverStripe\ORM\SS_List;
use Modular\Forms\TimeField;
 ...
 */
abstract class Field extends ModelExtension implements FieldInterface {
	use lang;
	use bitfield;
	use value;
	...
	public static function readonly_field_name($suffix = 'RO') {
		return static::single_field_name($suffix);
	}
	...
	public function extraStatics($class = null, $extension = null) {
		...
		if (!in_array(
			...
			$this->debug_fail(
				new Exception(
					"Can't add model field to '$class.$extension' as one of SingleFieldName '$fieldName' or SingleFieldSchema '$fieldSchema' is missing"
				)
			);
		}
